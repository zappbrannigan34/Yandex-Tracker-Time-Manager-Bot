...
- ✅ **Backfill:** автоматическое заполнение пропущенных дней с 120% покрытием
...
# Заполнить пропущенные дни (120% coverage algorithm)
...
**Backfill** автоматически заполняет пропущенные дни используя **120% coverage algorithm**:
